...
//!
//! Dials the matching `fix44_server`, then runs one full session: Logon,
...
//!
//! ```text
//! FIX_HOST=127.0.0.1 FIX_PORT=9876 cargo run --example fix44_client
//! ```
