/******************************************************************************
   ...
   Date: 21/7/26
******************************************************************************/
//! FIX 5.0 SP1 server example.
//!
//! Accepts connections from `fix50sp1_client` and answers Logon with Logon,
...
//!
//! ```text
//! FIX_HOST=0.0.0.0 FIX_PORT=9881 cargo run --example fix50sp1_server
//! ```
