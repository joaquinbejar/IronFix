...
//!
//! Dials the matching `fix41_server`, then runs one full session: Logon,
...
//!
//! ```text
//! FIX_HOST=127.0.0.1 FIX_PORT=9871 cargo run --example fix41_client
//! ```
...
const VERSION: FixVersion = FixVersion::Fix41;
