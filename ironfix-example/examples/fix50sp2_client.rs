/******************************************************************************
   ...
   Date: 21/7/26
******************************************************************************/
//! FIX 5.0 SP2 client example.
//!
//! Dials the matching `fix50sp2_server`, then runs one full session: Logon,
...
//!
//! ```text
//! FIX_HOST=127.0.0.1 FIX_PORT=9882 cargo run --example fix50sp2_client
//! ```
